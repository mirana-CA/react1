...

    {
        products.map(item=>{
          ...
          <div className="h-56 w-full">
            <a href="#">
              <img className="mx-auto h-full " src={item.img} alt={item.name} />
            </a>
          </div>
          <div className="pt-6">
            ...
            <div className="mt-4 flex items-center justify-between gap-4">
              ...
              <button type="button" className="inline-flex items-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-dark hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" onClick={()=>addToBasket(item)}>
                <svg className="-ms-2 me-2 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" color='#000'>
